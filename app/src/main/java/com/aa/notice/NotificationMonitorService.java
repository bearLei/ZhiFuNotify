...
//    private MediaPlayer payRecv;
    ...
    public void onCreate() {
        ...
        //支付宝
        String pattern = "(\\S*)通过扫码向你付款([\\d\\.]+)元(\\S*)";
...
//            payRecv.start();
        ...
        if ((pkgName.equals("io.va.exposed") || pkgName.equals("com.eg.android.AlipayGphone") && (title.contains("收钱码")|| title.contains("收款通知")) && text != null)) {
            // 现在创建 matcher 对象
            ...
            if (m.find()) {
                ...
                Log.d("lei","uName:"+uname+"---money:"+money+"mgroup3:"+group3);
